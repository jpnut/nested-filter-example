...
import { operatorToString as defaultOperatorToString } from 'react-nested-filter';
...
export const OperatorSelect: React.SFC<Props> = ({
  ...
  const handleChangeOperator = ({ target: { value } }: React.ChangeEvent<HTMLSelectElement>) => {
    setOperator(value);
  };
