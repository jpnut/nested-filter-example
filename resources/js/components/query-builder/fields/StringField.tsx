...
import { FieldProps, nullOperator } from 'react-nested-filter';
import { OperatorSelect } from './OperatorSelect';

export const StringField: React.SFC<FieldProps> = ({ value, setValue, operator, setOperator, operators }) => {
  ...
  return (
    <>
      ...
      <Box display="flex" flex={1} style={styles}>
        <TextField type="text" value={value || ''} onChange={handleChange} fullWidth />
      </Box>
    </>
  );
};
